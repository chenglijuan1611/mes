<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange" ref="handSelectTest_multipleTable" @row-click="handleRowClick">
    ...
    <el-dialog :close-on-click-modal='false' :title="title" :visible.sync="openDataScope" width="500px">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click.stop="submitDataScope">确 定</el-button>
        <el-button @click.stop="cancelDataScope">取 消</el-button>
      </div>
    </el-dialog>
  </div>
</template>

<template>
  <div>
    <img v-bind:src="options.img" @click.stop="editCropper()" title="点击上传头像" class="img-circle img-lg" />
    <el-dialog :close-on-click-modal='false' :title="title" :visible.sync="open" width="800px">
      ...
      <el-row>
        ...
        <el-col :lg="{span: 2, offset: 6}" :md="2">
          <el-button type="primary" size="small" @click.stop="uploadImg()">提 交</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>

  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" ref="handSelectTest_multipleTable" @row-click="handleRowClick">
    ...
    <el-dialog :close-on-click-modal='false' :title="upload.title" :visible.sync="upload.open" width="400px">
      ...
      >
        ...
        <div class="el-upload__tip" slot="tip">
          ...
          <el-link type="info" style="font-size:12px" @click.stop="importTemplate">下载模板</el-link>
        </div>
        <div class="el-upload__tip" style="color:red" slot="tip">提示：仅允许导入“xls”或“xlsx”格式文件！</div>
      </el-upload>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click.stop="submitFileForm">确 定</el-button>
        <el-button @click.stop="upload.open = false">取 消</el-button>
      </div>
    </el-dialog>
  </div>
</template>

<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="frameList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="数据帧" align="center" prop="frame" />
      <el-table-column label="0表示接收，1表示发送" align="center" prop="isDefault" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="数据帧" prop="frame">
          <el-input v-model="form.frame" placeholder="请输入数据帧" />
        </el-form-item>
        <el-form-item label="0表示接收，1表示发送" prop="isDefault">
          <el-input v-model="form.isDefault" placeholder="请输入0表示接收，1表示发送" />
        </el-form-item>
      </el-form>

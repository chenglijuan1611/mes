<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="处理人" prop="dealStatus">
        <el-select v-model="queryParams.dealStatus" placeholder="请选择处理人" clearable size="small">
    ...
    <el-table v-loading="loading" :data="feedbackList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="处理人" align="center" prop="dealStatus" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="反馈人" prop="feedbackUser">
          <el-input v-model="form.feedbackUser" placeholder="请输入反馈人" />
        </el-form-item>
        <el-form-item label="反馈时间" prop="feedbackTime">
          <el-date-picker clearable size="small" style="width: 200px"

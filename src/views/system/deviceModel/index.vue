<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="设备品类" prop="category">
        <el-input
      ...
      <el-form-item label="经销商" prop="companyCode">
        <el-input
    ...
    >
      ...
      <el-table-column label="固件版本" align="center" prop="firmwareCategory" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="经销商" prop="companyCode">
          <el-input v-model="form.companyCode" placeholder="经销商" />
        </el-form-item>
        <el-form-item label="型号编码" prop="modelCode">
        ...
        <el-form-item label="固件版本" prop="firmwareCategory">
          <el-input v-model="form.firmwareCategory" placeholder="请输入固件版本" />
        </el-form-item>
        <el-form-item label="创建人" prop="createUser">
...
<script>
import { listDeviceModel, getDeviceModel, delDeviceModel, addDeviceModel, updateDeviceModel, exportDeviceModel } from "@/api/system/deviceModel";
  ...
  methods: {
    ...
    getList() {
      ...
      listDeviceModel(this.queryParams).then(response => {
        this.deviceModelList = handleTree(response.data, "deviceModelId", "parentId");
        this.loading = false;
      });
    },
    /** 转换设备分类信息数据结构 */
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$confirm('是否确认删除设备分类信息编号为"' + row.deviceModelId + '"的数据项?', "警告", {

<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" ref="handSelectTest_multipleTable" @row-click="handleRowClick">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            size="small"
            icon="el-icon-download"
            @click.stop="handleGenTable(scope.row)"
            v-hasPermi="['tool:gen:code']"
          >生成代码</el-button>
        </template>
      </el-table-column>
    ...
    />
    <!-- 预览界面 -->
    <el-dialog :close-on-click-modal='false' :title="preview.title" :visible.sync="preview.open" width="80%" top="5vh">
...
export default {
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      downLoadZip("/tool/gen/batchGenCode?tables=" + tableNames, "dafeng");
    },
    /** 打开导入表弹窗 */
    openImportTable() {

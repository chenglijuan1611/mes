<template>
  <!-- 导入表 -->
  <el-dialog :close-on-click-modal='false' title="导入表" :visible.sync="visible" width="800px" top="5vh">
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="primary" @click.stop="handleImportTable">确 定</el-button>

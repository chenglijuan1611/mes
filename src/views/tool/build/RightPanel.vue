        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData['prefix-icon']!==undefined" label="前图标">
            <el-input v-model="activeData['prefix-icon']" placeholder="请输入前图标名称">
              <el-button slot="append" icon="el-icon-thumb" @click.stop="openIconsDialog('prefix-icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          <el-form-item v-if="activeData['suffix-icon'] !== undefined" label="后图标">
            <el-input v-model="activeData['suffix-icon']" placeholder="请输入后图标名称">
              <el-button slot="append" icon="el-icon-thumb" @click.stop="openIconsDialog('suffix-icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          ...
          <template v-if="['el-checkbox-group', 'el-radio-group', 'el-select'].indexOf(activeData.tag) > -1">
            ...
            >
              <div v-for="(item, index) in activeData.options" :key="index" class="select-item">
                ...
                />
                <div class="close-btn select-line-icon" @click.stop="activeData.options.splice(index, 1)">
          ...
          <template v-if="activeData.layout === 'colFormItem'">
            ...
            <div
              ...
              class="reg-item"
            >
              <span class="close-btn" @click.stop="activeData.regList.splice(index, 1)">
            ...
            <div style="margin-left: 20px">
              <el-button icon="el-icon-circle-plus-outline" type="text" @click.stop="addReg">
                添加规则
              </el-button>
            </div>
          </template>

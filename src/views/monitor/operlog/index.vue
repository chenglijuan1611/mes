<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange" ref="handSelectTest_multipleTable" @row-click="handleRowClick">
    ...
    <el-dialog :close-on-click-modal='false' title="操作日志详细" :visible.sync="open" width="700px">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click.stop="open = false">关 闭</el-button>
      </div>
    </el-dialog>
  </div>
</template>
